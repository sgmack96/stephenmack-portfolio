...
### [PULSE] r/wallstreetbets — July 14

**Sources:** r/wallstreetbets daily discussion thread — July 14, 2026

**What retail is saying:** SK Hynix up 27% on the US ADR after Monday's 15% Seoul crash. Same stock. Same week. "US pumps SK largest company 27% in a day and then will be shocked when they take profits tonight." The Korea-US arbitrage is now a daily spectator sport — WSB is literally begging Koreans not to sell overnight: "We had a good day koreans, do not fuck it up." IBM is the day's disaster: down 20%+ after warning AI is eating software budgets. "IBM should change their ticker to ICBM cuz i know some ports have been absolutely destroyed." Cramer recommended it the day before, which is being treated as causal: "Cramer recommended IBM yesterday. You genuinely cannot script this stuff." SpaceX bag-holders continue to bleed: "Space baggies so close to IPO negative I can taste it." And MSFT flipped to red after weeks of inexplicable green days, prompting: "SPY green, MU mega green, MSFT red. Everything is back on track."

**My take:** The SK Hynix ADR-KOSPI spread is becoming the market's most visible illustration of why cross-listed securities are structurally weird.

The ADR and the Korean shares can't be arbitraged efficiently because conversion only works one way — ADR to Korean shares, not the reverse. So the US and Korean prices can diverge indefinitely without a mechanism to force convergence. It's the same dynamic that keeps TSMC's ADR at a persistent premium to its Taipei listing. Monday's -15% in Seoul and Tuesday's +27% on the Nasdaq aren't contradictions. They're two different investor populations with different leverage structures, different margin rules, and different risk appetites, trading the same underlying asset without a reliable bridge.

The IBM story is the one that matters beyond the comedy. The CEO admitted they "faltered" — didn't react quickly enough to customers shifting spend from software licenses to AI infrastructure. That's not a macro problem. That's a specific and named budget reallocation: the dollar that used to go to IBM's software stack is now going to GPU clusters, memory chips, and inference compute. IBM is the first major tech company to say this plainly, and the market rewarded the honesty with a 20% haircut.
